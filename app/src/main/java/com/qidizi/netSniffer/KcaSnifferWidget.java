...
import static com.qidizi.netSniffer.KcaConstants.WIDGET_TOGGLE_ACTION;
...
public class KcaSnifferWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        int layout_id = isSnifferOn ? com.qidizi.netSniffer.R.layout.widget_btn_on : com.qidizi.netSniffer.R.layout.widget_btn_off;
    ...
    public void setWidget(Context context, AppWidgetManager manager, int[] appWidgetIds, boolean isSnifferOn) {
        ...
        views.setOnClickPendingIntent(com.qidizi.netSniffer.R.id.widget_vpnbtn, togglePendingIntent);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WIDGET_TOGGLE_ACTION.equals(action)) {
            ...
            if (sniffer_status) {
                ...
                Toast.makeText(context, context.getString(com.qidizi.netSniffer.R.string.ma_vpn_toggleoff).toUpperCase(), Toast.LENGTH_SHORT).show();
            } else {
                try {
                    ...
                    if (prepare == null) {
                        ...
                        Toast.makeText(context, context.getString(com.qidizi.netSniffer.R.string.widget_vpn_prepare_needed), Toast.LENGTH_LONG).show();
                        return;
                    }
                ...
                Toast.makeText(context, context.getString(com.qidizi.netSniffer.R.string.ma_vpn_toggleon).toUpperCase(), Toast.LENGTH_SHORT).show();
            }
