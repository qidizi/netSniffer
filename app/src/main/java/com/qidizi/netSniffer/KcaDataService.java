...
public class KcaDataService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        packet_db = new KcaPacketStore(getApplicationContext(), null, KcaConstants.PACKETSTORE_VERSION);
    ...
    public void handleServiceMessage(Message msg) {
        ...
        try {
            ...
            request = KcaUtils.joinStr(filtered, "&");
            ...
            intent.setAction(KcaConstants.BROADCAST_ACTION);
